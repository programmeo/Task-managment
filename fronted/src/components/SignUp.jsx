...
function SignUp() {
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    const url = `${import.meta.env.VITE_HOST_URI}/api/auth/register`;
  ...
  return (
    <div className="flex justify-center items-center p-10 w-full ">
      <form onSubmit={handleSignup} className="w-full md:max-w-md mdmx-auto ">
        <div className="grid md:grid-cols-0 md:gap-6">
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              className="block py-2.5 px-0 w-full text-sm text-[var(--foreground-primary)] bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-[var(--accent-primary)] focus:border-[var(--accent-primary)] focus:outline-none focus:ring-0 peer"
              placeholder=" "
              required
            />
            <label
